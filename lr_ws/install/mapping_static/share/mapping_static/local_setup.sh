...
: ${AMENT_CURRENT_PREFIX:="/root/Lunar_ROADSTER/lr_ws/install/mapping_static"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mapping_static/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mapping_static/environment/path.sh"
