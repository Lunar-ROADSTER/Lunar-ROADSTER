...
class ActuatorCommand(metaclass=Metaclass_ActuatorCommand):
    ...
    def __init__(self, **kwargs):
        ...
        self.wheel_velocity = kwargs.get(
            'wheel_velocity', ActuatorCommand.WHEEL_VELOCITY__DEFAULT)
        self.steer_position = kwargs.get(
            'steer_position', ActuatorCommand.STEER_POSITION__DEFAULT)
        self.tool_position = kwargs.get(
            'tool_position', ActuatorCommand.TOOL_POSITION__DEFAULT)
