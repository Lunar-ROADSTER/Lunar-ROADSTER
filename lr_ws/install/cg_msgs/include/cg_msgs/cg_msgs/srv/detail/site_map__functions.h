...
#ifndef CG_MSGS__SRV__DETAIL__SITE_MAP__FUNCTIONS_H_
#define CG_MSGS__SRV__DETAIL__SITE_MAP__FUNCTIONS_H_
...
/// Initialize srv/SiteMap message.
/**
...
/// Create srv/SiteMap message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cg_msgs__srv__SiteMap_Request__init().
...
/// Destroy srv/SiteMap message.
/**
 * It calls
 * cg_msgs__srv__SiteMap_Request__fini()
...
/// Check for srv/SiteMap message equality.
/**
...
/// Initialize array of srv/SiteMap messages.
/**
...
/// Finalize array of srv/SiteMap messages.
/**
 * It calls
 * cg_msgs__srv__SiteMap_Request__fini()
...
/// Create array of srv/SiteMap messages.
/**
 * It allocates the memory for the array and calls
 * cg_msgs__srv__SiteMap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SiteMap messages.
/**
 * It calls
 * cg_msgs__srv__SiteMap_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SiteMap message array equality.
/**
...
/// Copy an array of srv/SiteMap messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cg_msgs__srv__SiteMap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cg_msgs
...
/**
 * It calls
 * cg_msgs__srv__SiteMap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_cg_msgs
...
/**
 * It allocates the memory for the array and calls
 * cg_msgs__srv__SiteMap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cg_msgs
...
/**
 * It calls
 * cg_msgs__srv__SiteMap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CG_MSGS__SRV__DETAIL__SITE_MAP__FUNCTIONS_H_
