...
#ifndef CG_MSGS__MSG__DETAIL__ACTUATOR_COMMAND__STRUCT_HPP_
#define CG_MSGS__MSG__DETAIL__ACTUATOR_COMMAND__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__cg_msgs__msg__ActuatorCommand __attribute__((deprecated))
#else
# define DEPRECATED__cg_msgs__msg__ActuatorCommand __declspec(deprecated)
#endif
...
struct ActuatorCommand_
{
  ...
  // pointer types
  using RawPtr =
    cg_msgs::msg::ActuatorCommand_<ContainerAllocator> *;
  using ConstRawPtr =
    const cg_msgs::msg::ActuatorCommand_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<cg_msgs::msg::ActuatorCommand_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<cg_msgs::msg::ActuatorCommand_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      cg_msgs::msg::ActuatorCommand_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<cg_msgs::msg::ActuatorCommand_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<cg_msgs::msg::ActuatorCommand_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<cg_msgs::msg::ActuatorCommand_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<cg_msgs::msg::ActuatorCommand_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__cg_msgs__msg__ActuatorCommand
    std::shared_ptr<cg_msgs::msg::ActuatorCommand_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__cg_msgs__msg__ActuatorCommand
    std::shared_ptr<cg_msgs::msg::ActuatorCommand_<ContainerAllocator> const>
...
using ActuatorCommand =
  cg_msgs::msg::ActuatorCommand_<std::allocator<void>>;
...
#endif  // CG_MSGS__MSG__DETAIL__ACTUATOR_COMMAND__STRUCT_HPP_
