...
{
  new (message_memory) lx_msgs::msg::RoverCommand(_init);
}

void RoverCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<lx_msgs::msg::RoverCommand *>(message_memory);
  typed_message->~RoverCommand();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember RoverCommand_message_member_array[3] = {
  {
    "mobility_twist",  // name
    ...
    offsetof(lx_msgs::msg::RoverCommand, mobility_twist),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(lx_msgs::msg::RoverCommand, actuator_speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(lx_msgs::msg::RoverCommand, drum_speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RoverCommand_message_members = {
  ...
  3,  // number of fields
  sizeof(lx_msgs::msg::RoverCommand),
...
{
  return &::lx_msgs::msg::rosidl_typesupport_introspection_cpp::RoverCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lx_msgs, msg, RoverCommand)() {
  return &::lx_msgs::msg::rosidl_typesupport_introspection_cpp::RoverCommand_message_type_support_handle;
}
