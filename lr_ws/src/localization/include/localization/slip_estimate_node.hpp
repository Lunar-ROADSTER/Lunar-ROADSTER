...
#include <lr_msgs/msg/slip.hpp>
#include <lr_msgs/msg/actuator_state.hpp>
...
private: 
  ...
  lr::localization::KalmanFilterLinear kf_vel_;

  /* Callbacks */
  void actStateCallback(const lr_msgs::msg::ActuatorState::SharedPtr msg);
