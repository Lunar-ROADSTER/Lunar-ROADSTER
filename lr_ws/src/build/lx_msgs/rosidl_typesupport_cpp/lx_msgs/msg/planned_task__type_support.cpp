...
static const _PlannedTask_type_support_symbol_names_t _PlannedTask_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lx_msgs, msg, PlannedTask)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lx_msgs, msg, PlannedTask)),
  }
};
...
{
  return &::lx_msgs::msg::rosidl_typesupport_cpp::PlannedTask_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lx_msgs, msg, PlannedTask)() {
  return get_message_type_support_handle<lx_msgs::msg::PlannedTask>();
}
