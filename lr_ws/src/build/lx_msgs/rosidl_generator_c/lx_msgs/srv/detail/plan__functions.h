...
#ifndef LX_MSGS__SRV__DETAIL__PLAN__FUNCTIONS_H_
#define LX_MSGS__SRV__DETAIL__PLAN__FUNCTIONS_H_
...
/// Create srv/Plan message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * lx_msgs__srv__Plan_Request__init().
...
/// Destroy srv/Plan message.
/**
 * It calls
 * lx_msgs__srv__Plan_Request__fini()
...
/// Check for srv/Plan message equality.
/**
...
/// Initialize array of srv/Plan messages.
/**
...
/// Finalize array of srv/Plan messages.
/**
 * It calls
 * lx_msgs__srv__Plan_Request__fini()
...
/// Create array of srv/Plan messages.
/**
 * It allocates the memory for the array and calls
 * lx_msgs__srv__Plan_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Plan messages.
/**
 * It calls
 * lx_msgs__srv__Plan_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Plan message array equality.
/**
...
/// Copy an array of srv/Plan messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * lx_msgs__srv__Plan_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lx_msgs
...
/**
 * It calls
 * lx_msgs__srv__Plan_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_lx_msgs
...
/**
 * It allocates the memory for the array and calls
 * lx_msgs__srv__Plan_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lx_msgs
...
/**
 * It calls
 * lx_msgs__srv__Plan_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LX_MSGS__SRV__DETAIL__PLAN__FUNCTIONS_H_
