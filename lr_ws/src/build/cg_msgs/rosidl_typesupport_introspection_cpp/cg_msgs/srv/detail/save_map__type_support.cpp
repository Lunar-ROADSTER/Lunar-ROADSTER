...
{
  new (message_memory) cg_msgs::srv::SaveMap_Request(_init);
}

void SaveMap_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cg_msgs::srv::SaveMap_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SaveMap_Request_message_member_array[1] = {
  {
    ...
    offsetof(cg_msgs::srv::SaveMap_Request, filepath),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SaveMap_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(cg_msgs::srv::SaveMap_Request),
...
{
  return &::cg_msgs::srv::rosidl_typesupport_introspection_cpp::SaveMap_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cg_msgs, srv, SaveMap_Request)() {
  return &::cg_msgs::srv::rosidl_typesupport_introspection_cpp::SaveMap_Request_message_type_support_handle;
}
...
void SaveMap_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) cg_msgs::srv::SaveMap_Response(_init);
}

void SaveMap_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cg_msgs::srv::SaveMap_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SaveMap_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cg_msgs::srv::SaveMap_Response, map_saved),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SaveMap_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(cg_msgs::srv::SaveMap_Response),
...
{
  return &::cg_msgs::srv::rosidl_typesupport_introspection_cpp::SaveMap_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cg_msgs, srv, SaveMap_Response)() {
  return &::cg_msgs::srv::rosidl_typesupport_introspection_cpp::SaveMap_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SaveMap_service_members = {
  ...
  // see get_service_type_support_handle<cg_msgs::srv::SaveMap>()
...
get_service_type_support_handle<cg_msgs::srv::SaveMap>()
{
  ...
  auto service_type_support =
    &::cg_msgs::srv::rosidl_typesupport_introspection_cpp::SaveMap_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cg_msgs, srv, SaveMap)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<cg_msgs::srv::SaveMap>();
}
