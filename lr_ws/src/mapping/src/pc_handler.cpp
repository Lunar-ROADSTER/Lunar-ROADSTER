 ...
 * - /mapping/pcl_ground_height: [std_msgs::msg::Float64] Estimated ground height in meters (currently commented out).
 * - /mapping/ground_pointcloud: [sensor_msgs::msg::PointCloud2] Cropped ground points (currently published only in debug mode).
 *
 * Services:
 * - None
 *
