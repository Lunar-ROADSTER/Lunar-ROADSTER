...
#include <lr_msgs/msg/encoder_telemetry.hpp>
// Diagnostics
...
private:
  ...
  rclcpp::Subscription<lr_msgs::msg::ActuatorCommand>::SharedPtr cmd_sub_;
  rclcpp::TimerBase::SharedPtr timer_;

  // Reading commands from arduino
  rclcpp::Subscription<std_msgs::msg::Int64>::SharedPtr ard_sub_;
  rclcpp::Publisher<lr_msgs::msg::EncoderTelemetry>::SharedPtr enc_pub_;
  ...
  /* Message data */
  lr_msgs::msg::ActuatorCommand actuator_cmd_; // Actuator command to send to arduino
  std_msgs::msg::Int64 ard_feedback_;
  lr_msgs::msg::EncoderTelemetry enc_telemetry_;
  ...
  void cmdCallback(const lr_msgs::msg::ActuatorCommand::SharedPtr msg);
