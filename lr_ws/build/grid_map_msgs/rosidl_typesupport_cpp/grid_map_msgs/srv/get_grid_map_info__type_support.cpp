...
static const _GetGridMapInfo_Request_type_support_symbol_names_t _GetGridMapInfo_Request_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, grid_map_msgs, srv, GetGridMapInfo_Request)),
  }
};
...
static const _GetGridMapInfo_Response_type_support_symbol_names_t _GetGridMapInfo_Response_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, grid_map_msgs, srv, GetGridMapInfo_Response)),
  }
};
...
static const _GetGridMapInfo_type_support_symbol_names_t _GetGridMapInfo_service_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, grid_map_msgs, srv, GetGridMapInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, grid_map_msgs, srv, GetGridMapInfo)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<grid_map_msgs::srv::GetGridMapInfo>();
}
