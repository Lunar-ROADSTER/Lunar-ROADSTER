...
#include "cg_msgs/msg/detail/actuator_state__rosidl_typesupport_fastrtps_c.h"
...
using _ActuatorState__ros_msg_type = cg_msgs__msg__ActuatorState;
...
size_t get_serialized_size_cg_msgs__msg__ActuatorState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ActuatorState__ros_msg_type * ros_message = static_cast<const _ActuatorState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ActuatorState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cg_msgs__msg__ActuatorState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_msgs
size_t max_serialized_size_cg_msgs__msg__ActuatorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cg_msgs__msg__ActuatorState;
    is_plain =
      (
...
static size_t _ActuatorState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cg_msgs__msg__ActuatorState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cg_msgs, msg, ActuatorState)() {
