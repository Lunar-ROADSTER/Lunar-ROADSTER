...
#include "cg_msgs/msg/detail/beacon_tag__rosidl_typesupport_fastrtps_c.h"
...
using _BeaconTag__ros_msg_type = cg_msgs__msg__BeaconTag;

static bool _BeaconTag__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BeaconTag__ros_msg_type * ros_message = static_cast<const _BeaconTag__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _BeaconTag__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _BeaconTag__ros_msg_type * ros_message = static_cast<_BeaconTag__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _BeaconTag__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cg_msgs__msg__BeaconTag(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cg_msgs__msg__BeaconTag;
    is_plain =
      (
...
static size_t _BeaconTag__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_cg_msgs__msg__BeaconTag(
...
static message_type_support_callbacks_t __callbacks_BeaconTag = {
  "cg_msgs::msg",
  "BeaconTag",
  _BeaconTag__cdr_serialize,
  _BeaconTag__cdr_deserialize,
  _BeaconTag__get_serialized_size,
  _BeaconTag__max_serialized_size
};

static rosidl_message_type_support_t _BeaconTag__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BeaconTag,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cg_msgs, msg, BeaconTag)() {
  return &_BeaconTag__type_support;
}
