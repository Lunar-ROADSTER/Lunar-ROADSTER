...
#include "cg_msgs/msg/detail/encoder_telemetry__rosidl_typesupport_fastrtps_c.h"
...
using _EncoderTelemetry__ros_msg_type = cg_msgs__msg__EncoderTelemetry;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EncoderTelemetry__ros_msg_type * ros_message = static_cast<const _EncoderTelemetry__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: steer_pos_front
  {
    cdr << ros_message->steer_pos_front;
  }

  // Field name: steer_pos_rear
  {
  ...
  // Field name: drive_vel_front
  {
    cdr << ros_message->drive_vel_front;
  }

  // Field name: drive_vel_rear
  {
    cdr << ros_message->drive_vel_rear;
  }

  // Field name: drive_delta_front
  {
    cdr << ros_message->drive_delta_front;
  }

  // Field name: drive_delta_rear
  {
    cdr << ros_message->drive_delta_rear;
  }

  // Field name: term_byte
  {
  ...
  void * untyped_ros_message)
{
  ...
  _EncoderTelemetry__ros_msg_type * ros_message = static_cast<_EncoderTelemetry__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_cg_msgs__msg__EncoderTelemetry(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _EncoderTelemetry__ros_msg_type * ros_message = static_cast<const _EncoderTelemetry__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _EncoderTelemetry__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cg_msgs__msg__EncoderTelemetry(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_msgs
size_t max_serialized_size_cg_msgs__msg__EncoderTelemetry(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cg_msgs__msg__EncoderTelemetry;
    is_plain =
      (
...
static size_t _EncoderTelemetry__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cg_msgs__msg__EncoderTelemetry(
...
static message_type_support_callbacks_t __callbacks_EncoderTelemetry = {
  "cg_msgs::msg",
  "EncoderTelemetry",
...
static rosidl_message_type_support_t _EncoderTelemetry__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_EncoderTelemetry,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cg_msgs, msg, EncoderTelemetry)() {
  return &_EncoderTelemetry__type_support;
}
