...
static const _BeaconTag_type_support_symbol_names_t _BeaconTag_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cg_msgs, msg, BeaconTag)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cg_msgs, msg, BeaconTag)),
  }
};
...
{
  return &::cg_msgs::msg::rosidl_typesupport_cpp::BeaconTag_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cg_msgs, msg, BeaconTag)() {
  return get_message_type_support_handle<cg_msgs::msg::BeaconTag>();
}
