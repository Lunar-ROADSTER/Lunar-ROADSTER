...
static const _EnableWorksystem_Request_type_support_symbol_names_t _EnableWorksystem_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cg_msgs, srv, EnableWorksystem_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cg_msgs, srv, EnableWorksystem_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cg_msgs, srv, EnableWorksystem_Request)() {
  return &::cg_msgs::srv::rosidl_typesupport_c::EnableWorksystem_Request_message_type_support_handle;
}
...
static const _EnableWorksystem_Response_type_support_symbol_names_t _EnableWorksystem_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cg_msgs, srv, EnableWorksystem_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cg_msgs, srv, EnableWorksystem_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cg_msgs, srv, EnableWorksystem_Response)() {
  return &::cg_msgs::srv::rosidl_typesupport_c::EnableWorksystem_Response_message_type_support_handle;
}
...
static const _EnableWorksystem_type_support_symbol_names_t _EnableWorksystem_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cg_msgs, srv, EnableWorksystem)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cg_msgs, srv, EnableWorksystem)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, cg_msgs, srv, EnableWorksystem)() {
  return &::cg_msgs::srv::rosidl_typesupport_c::EnableWorksystem_service_type_support_handle;
}
