...
#ifndef CG_MSGS__MSG__DETAIL__ACTUATOR_STATE__TRAITS_HPP_
#define CG_MSGS__MSG__DETAIL__ACTUATOR_STATE__TRAITS_HPP_
...
inline void to_yaml(
  const cg_msgs::msg::ActuatorState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const cg_msgs::msg::ActuatorState & msg)
{
  return cg_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<cg_msgs::msg::ActuatorState>()
{
  return "cg_msgs::msg::ActuatorState";
}

template<>
inline const char * name<cg_msgs::msg::ActuatorState>()
{
  return "cg_msgs/msg/ActuatorState";
}

template<>
struct has_fixed_size<cg_msgs::msg::ActuatorState>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<cg_msgs::msg::ActuatorState>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<cg_msgs::msg::ActuatorState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // CG_MSGS__MSG__DETAIL__ACTUATOR_STATE__TRAITS_HPP_
