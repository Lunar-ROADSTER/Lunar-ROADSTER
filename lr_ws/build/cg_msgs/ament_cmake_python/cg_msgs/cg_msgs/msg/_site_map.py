...
class SiteMap(metaclass=Metaclass_SiteMap):
    ...
    def __init__(self, **kwargs):
        ...
        self.height_map = array.array('f', kwargs.get('height_map', []))
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.height_map != other.height_map:
            return False
        return True
    ...
    def height_map(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'f', \
                "The 'height_map' array.array() must have the type code of 'f'"
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'height_map' field must be a set or sequence and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
        self._height_map = array.array('f', value)
