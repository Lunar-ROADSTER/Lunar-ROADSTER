...
#include "cg_msgs/srv/detail/save_map__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cg_msgs::srv::SaveMap_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cg_msgs::srv::SaveMap_Request & ros_message)
{
  // Member: filepath
  cdr >> ros_message.filepath;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cg_msgs::srv::SaveMap_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cg_msgs::srv::SaveMap_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cg_msgs::srv::SaveMap_Request *>(
    untyped_ros_message);
...
{
  return &cg_msgs::srv::typesupport_fastrtps_cpp::_SaveMap_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cg_msgs, srv, SaveMap_Request)() {
  return &cg_msgs::srv::typesupport_fastrtps_cpp::_SaveMap_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cg_msgs
cdr_serialize(
  const cg_msgs::srv::SaveMap_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: map_saved
  cdr << (ros_message.map_saved ? true : false);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cg_msgs::srv::SaveMap_Response & ros_message)
{
  // Member: map_saved
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message.map_saved = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: map_saved
  {
    size_t item_size = sizeof(ros_message.map_saved);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cg_msgs::srv::SaveMap_Response;
    is_plain =
      (
      offsetof(DataType, map_saved) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const cg_msgs::srv::SaveMap_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cg_msgs::srv::SaveMap_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cg_msgs::srv::typesupport_fastrtps_cpp::_SaveMap_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cg_msgs, srv, SaveMap_Response)() {
  return &cg_msgs::srv::typesupport_fastrtps_cpp::_SaveMap_Response__handle;
}
...
{
  return &cg_msgs::srv::typesupport_fastrtps_cpp::_SaveMap__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cg_msgs, srv, SaveMap)() {
  return &cg_msgs::srv::typesupport_fastrtps_cpp::_SaveMap__handle;
}
