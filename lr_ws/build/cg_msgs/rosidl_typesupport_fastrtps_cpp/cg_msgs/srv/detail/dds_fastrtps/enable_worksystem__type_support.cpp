...
#include "cg_msgs/srv/detail/enable_worksystem__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cg_msgs::srv::EnableWorksystem_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cg_msgs::srv::EnableWorksystem_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cg_msgs::srv::EnableWorksystem_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EnableWorksystem_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cg_msgs::srv::EnableWorksystem_Request *>(
...
static size_t _EnableWorksystem_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EnableWorksystem_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EnableWorksystem_Request__callbacks = {
  "cg_msgs::srv",
...
static rosidl_message_type_support_t _EnableWorksystem_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EnableWorksystem_Request__callbacks,
...
{
  return &cg_msgs::srv::typesupport_fastrtps_cpp::_EnableWorksystem_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cg_msgs::srv::EnableWorksystem_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cg_msgs::srv::EnableWorksystem_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cg_msgs::srv::EnableWorksystem_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EnableWorksystem_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cg_msgs::srv::EnableWorksystem_Response *>(
...
static size_t _EnableWorksystem_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EnableWorksystem_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EnableWorksystem_Response__callbacks = {
  "cg_msgs::srv",
...
static rosidl_message_type_support_t _EnableWorksystem_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EnableWorksystem_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &cg_msgs::srv::typesupport_fastrtps_cpp::_EnableWorksystem_Response__handle;
}
...
static service_type_support_callbacks_t _EnableWorksystem__callbacks = {
  "cg_msgs::srv",
  "EnableWorksystem",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cg_msgs, srv, EnableWorksystem_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cg_msgs, srv, EnableWorksystem_Response)(),
...
static rosidl_service_type_support_t _EnableWorksystem__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EnableWorksystem__callbacks,
...
{
  return &cg_msgs::srv::typesupport_fastrtps_cpp::_EnableWorksystem__handle;
}
