...
#include "cg_msgs/msg/detail/actuator_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cg_msgs::msg::ActuatorCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cg_msgs::msg::ActuatorCommand & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cg_msgs::msg::ActuatorCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cg_msgs::msg::ActuatorCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cg_msgs::msg::ActuatorCommand *>(
    untyped_ros_message);
...
{
  return &cg_msgs::msg::typesupport_fastrtps_cpp::_ActuatorCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cg_msgs, msg, ActuatorCommand)() {
  return &cg_msgs::msg::typesupport_fastrtps_cpp::_ActuatorCommand__handle;
}
