...
#include "cg_msgs/msg/detail/pose2_d__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: pt
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cg_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Point2D(
  ...
  if (is_plain) {
    ...
    using DataType = cg_msgs::msg::Pose2D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cg_msgs::msg::Pose2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cg_msgs::msg::Pose2D *>(
    untyped_ros_message);
...
{
  return &cg_msgs::msg::typesupport_fastrtps_cpp::_Pose2D__handle;
}
