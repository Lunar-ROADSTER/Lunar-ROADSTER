...
#include "cg_msgs/msg/detail/actuator_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cg_msgs::msg::ActuatorState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cg_msgs::msg::ActuatorState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cg_msgs::msg::ActuatorState *>(
    untyped_ros_message);
...
{
  return &cg_msgs::msg::typesupport_fastrtps_cpp::_ActuatorState__handle;
}
