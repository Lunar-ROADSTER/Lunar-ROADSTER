...
#include "lx_msgs/srv/detail/switch__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lx_msgs::srv::Switch_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lx_msgs::srv::Switch_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lx_msgs::srv::Switch_Request *>(
    untyped_ros_message);
...
{
  return &lx_msgs::srv::typesupport_fastrtps_cpp::_Switch_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = lx_msgs::srv::Switch_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lx_msgs::srv::Switch_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<lx_msgs::srv::Switch_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &lx_msgs::srv::typesupport_fastrtps_cpp::_Switch_Response__handle;
}
...
static rosidl_service_type_support_t _Switch__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Switch__callbacks,
...
{
  return &lx_msgs::srv::typesupport_fastrtps_cpp::_Switch__handle;
}
