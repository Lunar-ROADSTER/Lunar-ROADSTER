...
static const _RequestRoverService_Request_type_support_symbol_names_t _RequestRoverService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lx_msgs, srv, RequestRoverService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lx_msgs, srv, RequestRoverService_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lx_msgs, srv, RequestRoverService_Request)() {
  return &::lx_msgs::srv::rosidl_typesupport_c::RequestRoverService_Request_message_type_support_handle;
}
...
static const _RequestRoverService_Response_type_support_symbol_names_t _RequestRoverService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lx_msgs, srv, RequestRoverService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lx_msgs, srv, RequestRoverService_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lx_msgs, srv, RequestRoverService_Response)() {
  return &::lx_msgs::srv::rosidl_typesupport_c::RequestRoverService_Response_message_type_support_handle;
}
...
static const _RequestRoverService_type_support_symbol_names_t _RequestRoverService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lx_msgs, srv, RequestRoverService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lx_msgs, srv, RequestRoverService)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, lx_msgs, srv, RequestRoverService)() {
  return &::lx_msgs::srv::rosidl_typesupport_c::RequestRoverService_service_type_support_handle;
}
