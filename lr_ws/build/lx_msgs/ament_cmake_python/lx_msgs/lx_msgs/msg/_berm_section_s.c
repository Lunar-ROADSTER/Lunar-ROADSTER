...
bool lx_msgs__msg__berm_section__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lx_msgs.msg._berm_section.BermSection", full_classname_dest, 37) == 0);
  }
  lx_msgs__msg__BermSection * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of BermSection */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lx_msgs.msg._berm_section");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BermSection");
