...
lx_msgs__action__Operation_Goal__init(lx_msgs__action__Operation_Goal * msg)
{
  ...
  // requested_berm_config
  if (!lx_msgs__msg__BermConfig__init(&msg->requested_berm_config)) {
    lx_msgs__action__Operation_Goal__fini(msg);
    return false;
  }
  return true;
}
...
lx_msgs__action__Operation_Goal__fini(lx_msgs__action__Operation_Goal * msg)
{
  ...
  // requested_berm_config
  lx_msgs__msg__BermConfig__fini(&msg->requested_berm_config);
}
...
lx_msgs__action__Operation_Goal__are_equal(const lx_msgs__action__Operation_Goal * lhs, const lx_msgs__action__Operation_Goal * rhs)
{
  ...
  // requested_berm_config
  if (!lx_msgs__msg__BermConfig__are_equal(
      &(lhs->requested_berm_config), &(rhs->requested_berm_config)))
  {
    return false;
  }
  return true;
  ...
  lx_msgs__action__Operation_Goal * output)
{
  ...
  if (!lx_msgs__msg__BermConfig__copy(
      &(input->requested_berm_config), &(output->requested_berm_config)))
  {
    return false;
  }
  return true;
...
lx_msgs__action__Operation_Goal__create()
{
  ...
  lx_msgs__action__Operation_Goal * msg = (lx_msgs__action__Operation_Goal *)allocator.allocate(sizeof(lx_msgs__action__Operation_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lx_msgs__action__Operation_Goal));
  bool success = lx_msgs__action__Operation_Goal__init(msg);
  if (!success) {
...
lx_msgs__action__Operation_Goal__Sequence__init(lx_msgs__action__Operation_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_Goal * data = NULL;

  if (size) {
    data = (lx_msgs__action__Operation_Goal *)allocator.zero_allocate(size, sizeof(lx_msgs__action__Operation_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lx_msgs__action__Operation_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        lx_msgs__action__Operation_Goal__fini(&data[i - 1]);
      }
...
lx_msgs__action__Operation_Goal__Sequence__fini(lx_msgs__action__Operation_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      lx_msgs__action__Operation_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_Goal__Sequence * array = (lx_msgs__action__Operation_Goal__Sequence *)allocator.allocate(sizeof(lx_msgs__action__Operation_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lx_msgs__action__Operation_Goal__Sequence__init(array, size);
  if (!success) {
...
lx_msgs__action__Operation_Goal__Sequence__destroy(lx_msgs__action__Operation_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lx_msgs__action__Operation_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lx_msgs__action__Operation_Goal__Sequence__are_equal(const lx_msgs__action__Operation_Goal__Sequence * lhs, const lx_msgs__action__Operation_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lx_msgs__action__Operation_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lx_msgs__action__Operation_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lx_msgs__action__Operation_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lx_msgs__action__Operation_Goal * data =
      (lx_msgs__action__Operation_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lx_msgs__action__Operation_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lx_msgs__action__Operation_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!lx_msgs__action__Operation_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_Result * msg = (lx_msgs__action__Operation_Result *)allocator.allocate(sizeof(lx_msgs__action__Operation_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lx_msgs__action__Operation_Result));
  bool success = lx_msgs__action__Operation_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
lx_msgs__action__Operation_Result__destroy(lx_msgs__action__Operation_Result * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    lx_msgs__action__Operation_Result__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
lx_msgs__action__Operation_Result__Sequence__init(lx_msgs__action__Operation_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_Result * data = NULL;

  if (size) {
    data = (lx_msgs__action__Operation_Result *)allocator.zero_allocate(size, sizeof(lx_msgs__action__Operation_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lx_msgs__action__Operation_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        lx_msgs__action__Operation_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
lx_msgs__action__Operation_Result__Sequence__fini(lx_msgs__action__Operation_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      lx_msgs__action__Operation_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_Result__Sequence * array = (lx_msgs__action__Operation_Result__Sequence *)allocator.allocate(sizeof(lx_msgs__action__Operation_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lx_msgs__action__Operation_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
lx_msgs__action__Operation_Result__Sequence__destroy(lx_msgs__action__Operation_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lx_msgs__action__Operation_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lx_msgs__action__Operation_Result__Sequence__are_equal(const lx_msgs__action__Operation_Result__Sequence * lhs, const lx_msgs__action__Operation_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lx_msgs__action__Operation_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lx_msgs__action__Operation_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lx_msgs__action__Operation_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lx_msgs__action__Operation_Result * data =
      (lx_msgs__action__Operation_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lx_msgs__action__Operation_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lx_msgs__action__Operation_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!lx_msgs__action__Operation_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_Feedback * msg = (lx_msgs__action__Operation_Feedback *)allocator.allocate(sizeof(lx_msgs__action__Operation_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lx_msgs__action__Operation_Feedback));
  bool success = lx_msgs__action__Operation_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
lx_msgs__action__Operation_Feedback__destroy(lx_msgs__action__Operation_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    lx_msgs__action__Operation_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
lx_msgs__action__Operation_Feedback__Sequence__init(lx_msgs__action__Operation_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_Feedback * data = NULL;

  if (size) {
    data = (lx_msgs__action__Operation_Feedback *)allocator.zero_allocate(size, sizeof(lx_msgs__action__Operation_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lx_msgs__action__Operation_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        lx_msgs__action__Operation_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
lx_msgs__action__Operation_Feedback__Sequence__fini(lx_msgs__action__Operation_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      lx_msgs__action__Operation_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_Feedback__Sequence * array = (lx_msgs__action__Operation_Feedback__Sequence *)allocator.allocate(sizeof(lx_msgs__action__Operation_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lx_msgs__action__Operation_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
lx_msgs__action__Operation_Feedback__Sequence__destroy(lx_msgs__action__Operation_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lx_msgs__action__Operation_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lx_msgs__action__Operation_Feedback__Sequence__are_equal(const lx_msgs__action__Operation_Feedback__Sequence * lhs, const lx_msgs__action__Operation_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lx_msgs__action__Operation_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lx_msgs__action__Operation_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lx_msgs__action__Operation_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lx_msgs__action__Operation_Feedback * data =
      (lx_msgs__action__Operation_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lx_msgs__action__Operation_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lx_msgs__action__Operation_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!lx_msgs__action__Operation_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
lx_msgs__action__Operation_SendGoal_Request__init(lx_msgs__action__Operation_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    lx_msgs__action__Operation_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!lx_msgs__action__Operation_Goal__init(&msg->goal)) {
    lx_msgs__action__Operation_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
lx_msgs__action__Operation_SendGoal_Request__fini(lx_msgs__action__Operation_SendGoal_Request * msg)
{
  ...
  // goal
  lx_msgs__action__Operation_Goal__fini(&msg->goal);
}
...
lx_msgs__action__Operation_SendGoal_Request__are_equal(const lx_msgs__action__Operation_SendGoal_Request * lhs, const lx_msgs__action__Operation_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!lx_msgs__action__Operation_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_SendGoal_Request * msg = (lx_msgs__action__Operation_SendGoal_Request *)allocator.allocate(sizeof(lx_msgs__action__Operation_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lx_msgs__action__Operation_SendGoal_Request));
  bool success = lx_msgs__action__Operation_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
lx_msgs__action__Operation_SendGoal_Request__Sequence__init(lx_msgs__action__Operation_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_SendGoal_Request * data = NULL;

  if (size) {
    data = (lx_msgs__action__Operation_SendGoal_Request *)allocator.zero_allocate(size, sizeof(lx_msgs__action__Operation_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lx_msgs__action__Operation_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        lx_msgs__action__Operation_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
lx_msgs__action__Operation_SendGoal_Request__Sequence__fini(lx_msgs__action__Operation_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      lx_msgs__action__Operation_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_SendGoal_Request__Sequence * array = (lx_msgs__action__Operation_SendGoal_Request__Sequence *)allocator.allocate(sizeof(lx_msgs__action__Operation_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lx_msgs__action__Operation_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
lx_msgs__action__Operation_SendGoal_Request__Sequence__destroy(lx_msgs__action__Operation_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lx_msgs__action__Operation_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lx_msgs__action__Operation_SendGoal_Request__Sequence__are_equal(const lx_msgs__action__Operation_SendGoal_Request__Sequence * lhs, const lx_msgs__action__Operation_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lx_msgs__action__Operation_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lx_msgs__action__Operation_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lx_msgs__action__Operation_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lx_msgs__action__Operation_SendGoal_Request * data =
      (lx_msgs__action__Operation_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lx_msgs__action__Operation_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lx_msgs__action__Operation_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!lx_msgs__action__Operation_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
lx_msgs__action__Operation_SendGoal_Response__init(lx_msgs__action__Operation_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    lx_msgs__action__Operation_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_SendGoal_Response * msg = (lx_msgs__action__Operation_SendGoal_Response *)allocator.allocate(sizeof(lx_msgs__action__Operation_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lx_msgs__action__Operation_SendGoal_Response));
  bool success = lx_msgs__action__Operation_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
lx_msgs__action__Operation_SendGoal_Response__Sequence__init(lx_msgs__action__Operation_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_SendGoal_Response * data = NULL;

  if (size) {
    data = (lx_msgs__action__Operation_SendGoal_Response *)allocator.zero_allocate(size, sizeof(lx_msgs__action__Operation_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lx_msgs__action__Operation_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        lx_msgs__action__Operation_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
lx_msgs__action__Operation_SendGoal_Response__Sequence__fini(lx_msgs__action__Operation_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      lx_msgs__action__Operation_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_SendGoal_Response__Sequence * array = (lx_msgs__action__Operation_SendGoal_Response__Sequence *)allocator.allocate(sizeof(lx_msgs__action__Operation_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lx_msgs__action__Operation_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
lx_msgs__action__Operation_SendGoal_Response__Sequence__destroy(lx_msgs__action__Operation_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lx_msgs__action__Operation_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lx_msgs__action__Operation_SendGoal_Response__Sequence__are_equal(const lx_msgs__action__Operation_SendGoal_Response__Sequence * lhs, const lx_msgs__action__Operation_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lx_msgs__action__Operation_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lx_msgs__action__Operation_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lx_msgs__action__Operation_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lx_msgs__action__Operation_SendGoal_Response * data =
      (lx_msgs__action__Operation_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lx_msgs__action__Operation_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lx_msgs__action__Operation_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!lx_msgs__action__Operation_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
lx_msgs__action__Operation_GetResult_Request__init(lx_msgs__action__Operation_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    lx_msgs__action__Operation_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_GetResult_Request * msg = (lx_msgs__action__Operation_GetResult_Request *)allocator.allocate(sizeof(lx_msgs__action__Operation_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lx_msgs__action__Operation_GetResult_Request));
  bool success = lx_msgs__action__Operation_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
lx_msgs__action__Operation_GetResult_Request__Sequence__init(lx_msgs__action__Operation_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_GetResult_Request * data = NULL;

  if (size) {
    data = (lx_msgs__action__Operation_GetResult_Request *)allocator.zero_allocate(size, sizeof(lx_msgs__action__Operation_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lx_msgs__action__Operation_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        lx_msgs__action__Operation_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
lx_msgs__action__Operation_GetResult_Request__Sequence__fini(lx_msgs__action__Operation_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      lx_msgs__action__Operation_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_GetResult_Request__Sequence * array = (lx_msgs__action__Operation_GetResult_Request__Sequence *)allocator.allocate(sizeof(lx_msgs__action__Operation_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lx_msgs__action__Operation_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
lx_msgs__action__Operation_GetResult_Request__Sequence__destroy(lx_msgs__action__Operation_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lx_msgs__action__Operation_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lx_msgs__action__Operation_GetResult_Request__Sequence__are_equal(const lx_msgs__action__Operation_GetResult_Request__Sequence * lhs, const lx_msgs__action__Operation_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lx_msgs__action__Operation_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lx_msgs__action__Operation_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lx_msgs__action__Operation_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lx_msgs__action__Operation_GetResult_Request * data =
      (lx_msgs__action__Operation_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lx_msgs__action__Operation_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lx_msgs__action__Operation_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!lx_msgs__action__Operation_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
lx_msgs__action__Operation_GetResult_Response__init(lx_msgs__action__Operation_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!lx_msgs__action__Operation_Result__init(&msg->result)) {
    lx_msgs__action__Operation_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
lx_msgs__action__Operation_GetResult_Response__fini(lx_msgs__action__Operation_GetResult_Response * msg)
{
  ...
  // status
  // result
  lx_msgs__action__Operation_Result__fini(&msg->result);
}
...
lx_msgs__action__Operation_GetResult_Response__are_equal(const lx_msgs__action__Operation_GetResult_Response * lhs, const lx_msgs__action__Operation_GetResult_Response * rhs)
{
  ...
  // result
  if (!lx_msgs__action__Operation_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_GetResult_Response * msg = (lx_msgs__action__Operation_GetResult_Response *)allocator.allocate(sizeof(lx_msgs__action__Operation_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lx_msgs__action__Operation_GetResult_Response));
  bool success = lx_msgs__action__Operation_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
lx_msgs__action__Operation_GetResult_Response__Sequence__init(lx_msgs__action__Operation_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_GetResult_Response * data = NULL;

  if (size) {
    data = (lx_msgs__action__Operation_GetResult_Response *)allocator.zero_allocate(size, sizeof(lx_msgs__action__Operation_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lx_msgs__action__Operation_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        lx_msgs__action__Operation_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
lx_msgs__action__Operation_GetResult_Response__Sequence__fini(lx_msgs__action__Operation_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      lx_msgs__action__Operation_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_GetResult_Response__Sequence * array = (lx_msgs__action__Operation_GetResult_Response__Sequence *)allocator.allocate(sizeof(lx_msgs__action__Operation_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lx_msgs__action__Operation_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
lx_msgs__action__Operation_GetResult_Response__Sequence__destroy(lx_msgs__action__Operation_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lx_msgs__action__Operation_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lx_msgs__action__Operation_GetResult_Response__Sequence__are_equal(const lx_msgs__action__Operation_GetResult_Response__Sequence * lhs, const lx_msgs__action__Operation_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lx_msgs__action__Operation_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lx_msgs__action__Operation_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lx_msgs__action__Operation_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lx_msgs__action__Operation_GetResult_Response * data =
      (lx_msgs__action__Operation_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lx_msgs__action__Operation_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lx_msgs__action__Operation_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!lx_msgs__action__Operation_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
lx_msgs__action__Operation_FeedbackMessage__init(lx_msgs__action__Operation_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    lx_msgs__action__Operation_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!lx_msgs__action__Operation_Feedback__init(&msg->feedback)) {
    lx_msgs__action__Operation_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
lx_msgs__action__Operation_FeedbackMessage__fini(lx_msgs__action__Operation_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  lx_msgs__action__Operation_Feedback__fini(&msg->feedback);
}
...
lx_msgs__action__Operation_FeedbackMessage__are_equal(const lx_msgs__action__Operation_FeedbackMessage * lhs, const lx_msgs__action__Operation_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!lx_msgs__action__Operation_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_FeedbackMessage * msg = (lx_msgs__action__Operation_FeedbackMessage *)allocator.allocate(sizeof(lx_msgs__action__Operation_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lx_msgs__action__Operation_FeedbackMessage));
  bool success = lx_msgs__action__Operation_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
lx_msgs__action__Operation_FeedbackMessage__Sequence__init(lx_msgs__action__Operation_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_FeedbackMessage * data = NULL;

  if (size) {
    data = (lx_msgs__action__Operation_FeedbackMessage *)allocator.zero_allocate(size, sizeof(lx_msgs__action__Operation_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lx_msgs__action__Operation_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        lx_msgs__action__Operation_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
lx_msgs__action__Operation_FeedbackMessage__Sequence__fini(lx_msgs__action__Operation_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      lx_msgs__action__Operation_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lx_msgs__action__Operation_FeedbackMessage__Sequence * array = (lx_msgs__action__Operation_FeedbackMessage__Sequence *)allocator.allocate(sizeof(lx_msgs__action__Operation_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lx_msgs__action__Operation_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
lx_msgs__action__Operation_FeedbackMessage__Sequence__destroy(lx_msgs__action__Operation_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lx_msgs__action__Operation_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lx_msgs__action__Operation_FeedbackMessage__Sequence__are_equal(const lx_msgs__action__Operation_FeedbackMessage__Sequence * lhs, const lx_msgs__action__Operation_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lx_msgs__action__Operation_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lx_msgs__action__Operation_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lx_msgs__action__Operation_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lx_msgs__action__Operation_FeedbackMessage * data =
      (lx_msgs__action__Operation_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lx_msgs__action__Operation_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lx_msgs__action__Operation_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!lx_msgs__action__Operation_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
